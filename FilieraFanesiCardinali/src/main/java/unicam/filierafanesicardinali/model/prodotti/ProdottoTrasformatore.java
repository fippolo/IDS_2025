...
public class ProdottoTrasformatore extends Prodotto {
	...
	public ProdottoTrasformatore(String nome, float prezzo, String descrizione, Trasformatore trasformatore, String processoDiTrasformazione) {
		super(nome, prezzo, descrizione,trasformatore);
